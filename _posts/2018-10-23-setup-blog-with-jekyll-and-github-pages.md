...
image: "/assets/images/posts/journaling.jpg"
categories: Guide
...
In this article I will show you step by step how I set up my own personal blog.
...
### Git and GitHub
If you want to host your blog via GitHub as a GitHub Page or on a custom domain, you will need have an account on GitHub and install Git.
You can get the latest version for Windows from [here](https://git-scm.com/downloads).
It's also possible to work with the portable version of Git.

Some source code editors and IDE tools offer a Git integration.
This will make it a little bit easier to work on your blog articles.
...
After the basic installation of Ruby you will get prompted to install the optional Devkit.
...
Bundler tracks and installs the Ruby gems and their versions you will use in your blog later.

## Initialization
### GitHub
Firstly you need to create a new repository on GitHub.
The name for your repository has to follow a certain naming convention in order to make it a GitHub Pages repository:

`<username>.github.io`

This repository is a so called user repository.
Other repositories are normal project repositories.
It's also possible to use a project repository instead of a user repository for your Jekyll blog, but we will focus on the latter.
